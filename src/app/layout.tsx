...
export const metadata: Metadata = {
  title: "Agri Advice",
  description: "Smart crop recommendations for better farming",
};
      ...
      >
        <main className="pb-8 opacity-90 bg-white bg-opacity-30">
          ...
          <div className="fixed top-0 w-full bg-gray-200 z-50 ">
            <section className="bg-gray-100 h-20 flex justify-between items-center px-4">
             <Link href="/">
              ...
              <div className="hidden md:flex justify-center items-center space-x-4">
                ...
                <Link href="/home" className="text-green-600 font-bold">
                  HOME
                </Link>
                <Link href="/soil-analysis" className="text-green-600 font-bold">
                  SOIL
                </Link>
                <Link href="/schedule" className="text-green-600 font-bold">
                  SCHEDULE
                </Link>
                <Link href="/community" className="text-green-600 font-bold">
                  COMMUNITY
                </Link>
          ...
          <div>
            <footer className="fixed bottom-0 w-full bg-gray-200 py-2 flex justify-center items-center">
              <p className="text-gray-500 text-center text-sm"> MADE BY HABIBI</p>
            </footer>
          </div>
        </main>
      </body>
